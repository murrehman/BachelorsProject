...
$sql=mysqli_query($con,"insert into category(categoryName, categoryPrice, categoryDescription) values('$category', $price, '$description')");
				...
				<div class="module">
					...
					<div class="module-body">
						...
						<form class="form-horizontal row-fluid" name="Category" method="post" >
							...
							<div class="control-group">
								<label class="control-label" for="basicinput">Add Price</label>
								<div class="controls">
									<input type="text" placeholder="Price"  name="price" class="span8 tip" required>
								</div>
							</div>
							<div class="control-group">
